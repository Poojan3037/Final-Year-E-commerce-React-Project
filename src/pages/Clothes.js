      ...
      <Container className="main-container">
        <Row className="justify-content-evenly">
          <Col className="sidebar" md={2}>
            <button className="sidebar-btn" onClick={getAllProducts}>
              All Products
            </button>
            <button className="sidebar-btn" onClick={getMenClothes}>
              Men
            </button>
            <button className="sidebar-btn" onClick={getWomenClothes}>
              Women
            </button>
          </Col>
          <Col md={10}>
