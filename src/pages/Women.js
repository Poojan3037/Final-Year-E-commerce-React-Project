      ...
      <Container className="main-container">
        <Row className="justify-content-evenly">
          <Col className="sidebar" md={2}>
            <button className="sidebar-btn" onClick={getWomenAllProducts}>
              All Products
            </button>
            <button className="sidebar-btn" onClick={getClothes}>
              Clothes
            </button>
            <button className="sidebar-btn" onClick={getShoes}>
              Shoes
            </button>
            <button className="sidebar-btn" onClick={getWatch}>
              Watch
            </button>
          </Col>
          <Col md={10}>
